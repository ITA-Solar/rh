...
void init_ncdf_atmos(Atmosphere *atmos, Geometry *geometry, Input_Atmos_file *infile)
...
/* ------- begin -------------------------- close_ncdf  ------------- */
void close_ncdf_atmos(Atmosphere *atmos, Geometry *geometry, Input_Atmos_file *infile)
