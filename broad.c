...
void Stark(AtomicLine *line, double *GStark)
{
  ...
  if (line->cStark < 0.0) {
   ...
   /* --- Modified by Graham Kerr, based on Yj Zhu's implementation. 
          This selects the Mg II h & k resonance lines, and subordinate lines, 
          and models the quadratic Stark effect in a more accurate manner. 
          Based on the Stark-B database. 
